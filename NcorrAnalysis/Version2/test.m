...
PreAnalyze(name,[1,563;755,1155;1314,1798;1825,2420; ...
            2450,2986;3012,3868;3894,5633;5660,11179],'sample2');
PreAnalyze(name,[14131,14943],'sample3');

name = 'sample8.mov';
%First two for sample 8, third for sample 9, all chordwise
PreAnalyze(name,[1,1983;2001,2468],'sample8');
PreAnalyze(name,[4480,5510],'sample9');

name = 'sample6.mov';
%All for sample 6
PreAnalyze(name,[1,1880;1909,4082;4116,6794;6825,10169; ...
            10212,10403;10808,13812],'sample6');
