...
codegen -config mexcfg el12_Ustrain_kirch -args {X, qe, E, nu, quad_nt, quad_xi, quad_eta, quad_zeta, quad_w}
codegen -config mexcfg el12_Ustrain_biot  -args {X, qe, E, nu, quad_nt, quad_xi, quad_eta, quad_zeta, quad_w}

codegen -config mexcfg el12_inertia -args {xe, ye, ze, ue, ve, we, rho, ref_pt, quad_nt, quad_xi, quad_eta, quad_zeta, quad_w}

codegen -config mexcfg el12_compute_DStrainEnergy_biot -args {X, qe, E, nu, quad_nt, quad_xi, quad_eta, quad_zeta, quad_w}
codegen -config mexcfg el12_compute_DStrainEnergy_kirch -args {X, qe, E, nu, quad_nt, quad_xi, quad_eta, quad_zeta, quad_w}

codegen -config mexcfg el12_compute_DVolume -args {X, qe, quad_nt, quad_xi, quad_eta, quad_zeta, quad_w}
