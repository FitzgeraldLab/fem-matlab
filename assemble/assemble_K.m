...
parfor e = 1:nel
    ...
    elseif eltype(e) == 13
        ...
        if( matype(e) == 1 )
            % Kirchoff Material
            [Ke, qs] = el13_ke_kirch(Xe, qe,E(e), nu(e), int32(el_quad.nt), el_quad.xi, el_quad.eta, el_quad.zeta, el_quad.w);
        elseif( matype(e) == 2 )
            % Biot Material
            [Ke, qs] = el13_ke_biot(Xe, qe, E(e), nu(e), int32(el_quad.nt), el_quad.xi, el_quad.eta, el_quad.zeta, el_quad.w);
        else
            fprintf(2','Error: unknown material type\n');
            %break
        end
