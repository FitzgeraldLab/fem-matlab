function inertia = el13_inertia(xe,ye,ze, ue,ve,we, MatDensity, ref_pt, quad_nt, quad_xi, quad_eta, quad_zeta, quad_w)
%#codegen
...
for i1 = 1:quad_nt
    ...
    [NN,NNxi,NNeta,NNzeta] = el13_ShapeFunctions(xi,eta,zeta);
